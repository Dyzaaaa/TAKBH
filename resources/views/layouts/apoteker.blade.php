        ...
        <div id="notificationPopup" class="hidden absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
          <div class="p-4">
            ...
            <div class="mt-2 space-y-2">
              ...
              <div class="p-2 hover:bg-gray-100 rounded-md">
                <p class="text-sm text-gray-700">Pembayaran berhasil diproses.</p>
...
<!-- Sidebar -->
<aside id="sidebar" class="fixed left-0 w-64 h-full top-10 mt-5 bg-white border-r shadow-lg transition-transform sm:translate-x-0 -translate-x-full z-30">
    <div class="h-full flex flex-col p-4">
        <!-- Menu -->
        <nav class="flex-1 mt-4">
            <ul class="space-y-2">
                <li>
                    <a href="dashboard" class="flex items-center p-3 text-gray-700 hover:bg-gray-200 rounded-md transition">
                ...
                <li>
                    <a href="data" class="flex items-center p-3 text-gray-700 hover:bg-gray-200 rounded-md transition">
                ...
                <li>
                    <a href="inventaris" class="flex items-center p-3 text-gray-700 hover:bg-gray-200 rounded-md transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <li>
                    <a href="kasir" class="flex items-center p-3 text-gray-700 hover:bg-gray-200 rounded-md transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <li>
                    <a href="keuangan" class="flex items-center p-3 text-gray-700 hover:bg-gray-200 rounded-md transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <!-- Logout -->
        <div class="mt-auto">
            <a href="logout" class="flex items-center p-3 text-red-600 hover:bg-red-100 rounded-md transition">
